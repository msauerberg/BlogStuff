...
plot(1990:2019, Median.1, col="green", main="Median Age at Death", type="l")
lines(1990:2019, Median.2, col="red")
lines(1990:2019, Median.3, col="blue")
legend(2010, 83, legend=c("formula","spline","loess"), lty=1, col=c("green","red","blue"))
       
plot(1990:2019, Modal.1, col="green", main="Modal Age at Death", type="l")
lines(1990:2019, Modal.2, col="red")
lines(1990:2019, Modal.3, col="blue")
legend(2010, 87, legend=c("formula","spline","loess"), lty=1, col=c("green","red","blue"))
       
```
The results suggest that all three methods produce similar results for the median age at death. For the modal age at death, method "formula" corresponds to the "spline" approach. The "loess" method, however, can lead to considerably different results.
