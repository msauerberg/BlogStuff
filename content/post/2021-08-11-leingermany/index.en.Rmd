...
###getting mode
Mode.LT.2019.f <- x[which.max(LE.women.2019$lt$dx)]
Mode.LT.2020.f <- x[which.max(LE.women.2020$lt$dx)]
Mode.LT.2019.m <- x[which.max(LE.men.2019$lt$dx)]
Mode.LT.2020.m <- x[which.max(LE.men.2020$lt$dx)]
